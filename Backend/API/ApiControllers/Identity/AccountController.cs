...
namespace API.ApiControllers.Identity;
...
public class AccountController : ControllerBase
{
    ...
    [ProducesResponseType(typeof(Application.DTOs.v1.Message), StatusCodes.Status404NotFound)]
    [HttpPost]
    ...
    )
    {
        ...
        if (appUser == null)
        {
            ...
            return NotFound(new Application.DTOs.v1.Message(UserPassProblem));
        }
    ...
    [Consumes("application/json")]
    [ProducesResponseType(typeof(JWTResponse), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(Application.DTOs.v1.Message), StatusCodes.Status400BadRequest)]
    [HttpPost]
    ...
    )
    {
        ...
        if (appUser != null)
        {
            ...
            return BadRequest(new Application.DTOs.v1.Message("User already registered"));
        }
        ...
        return BadRequest(new Application.DTOs.v1.Message() { Messages = errors });
    }
    ...
    )
    {
        ...
        try
        {
            ...
            if (jwtToken == null)
            {
                return BadRequest(new Application.DTOs.v1.Message("No token"));
            }
        }
        catch (Exception e)
        {
            return BadRequest(new Application.DTOs.v1.Message($"Cant parse the token, {e.Message}"));
        }
        ...
        if (userEmail == null)
        {
            return BadRequest(new Application.DTOs.v1.Message("No email in jwt"));
        }
    ...
    public async Task<ActionResult> Logout([FromBody] LogoutInfo logout)
    {
        ...
        {
            return NotFound(
                new Application.DTOs.v1.Message(UserPassProblem)
            );
        }
